Для быстрой проверки макета на "PerfectPixel" проект развернут на Github Pages. [Ссылка на готовую вёрстку](https://maxs2x.github.io/Brandmaker/dist/index.html)
